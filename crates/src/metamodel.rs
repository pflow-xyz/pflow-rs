...
pub mod metamodel {
    ...
    pub static METAMODEL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct Metamodel<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for Metamodel<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for Metamodel<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for Metamodel<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for Metamodel<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Metamodel)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Metamodel<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for MetamodelCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MetamodelCalls {
    ...
    impl ::core::fmt::Display for MetamodelCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ContextCall> for MetamodelCalls {
        fn from(value: ContextCall) -> Self {
            Self::Context(value)
        }
    }
    impl ::core::convert::From<LatestBlocksCall> for MetamodelCalls {
        fn from(value: LatestBlocksCall) -> Self {
            Self::LatestBlocks(value)
        }
    }
    impl ::core::convert::From<SequenceCall> for MetamodelCalls {
        fn from(value: SequenceCall) -> Self {
            Self::Sequence(value)
        }
    }
    impl ::core::convert::From<SignalCall> for MetamodelCalls {
        fn from(value: SignalCall) -> Self {
            Self::Signal(value)
        }
    }
    impl ::core::convert::From<SignalManyCall> for MetamodelCalls {
