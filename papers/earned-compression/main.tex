...
This confirms that turn enforcement is a structural property even though it does not satisfy the strict TEG definition.
Whether there exists a useful formal weakening of the TEG property---``tropical under mutual exclusion''---is an open question.
\end{remark}
