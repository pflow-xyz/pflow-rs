...
Constructing an explicit example of ranking disagreement, and characterizing the topological conditions under which the diagonal approximation preserves ordinal ranking, is an open problem.
\end{remark}
