...
\paragraph{Topology.}
Connect Four is played on a $7 \times 6$ grid (7~columns, 6~rows).
...
Unlike $n \times n$ tic-tac-toe, the non-square grid and shorter win length produce a richer drain-count distribution with seven distinct levels (3, 4, 5, 6, 7, 8, 10, 11, 13) rather than three.
...
\paragraph{Topology.}
Hex is played on a rhombic board with hexagonal cells.
