...
In the \emph{reverse} direction, \emph{integer reduction} recovers exact integers from continuous equilibrium: the steady-state concentrations $x_i^* = 1/n_i$ are inverted and normalized to yield $V_i = n_{\max}/n_i \in \mathbb{Q}^+$.
